...
if sys.platform != "win32":
    ...
    if sys.version_info >= (3, 7):
        ...
        class statvfs_result(_Tuple10Int):  # Unix only
            def __new__(
                cls, seq: Union[_Tuple10Int, _Tuple11Int], dict: Dict[str, int] = ...
            ) -> statvfs_result: ...
            n_fields: int
...
if sys.platform != "win32":
    ...
    if sys.platform == "linux":
        def getxattr(
            path: _FdOrAnyPath, attribute: AnyPath, *, follow_symlinks: bool = ...
        ) -> bytes: ...
        def listxattr(
            path: Optional[_FdOrAnyPath] = ..., *, follow_symlinks: bool = ...
        ) -> List[str]: ...
        def removexattr(
            path: _FdOrAnyPath, attribute: AnyPath, *, follow_symlinks: bool = ...
        ) -> None: ...
