...
class int:
    ...
    def __new__(
        cls: Type[_T],
        x: Union[str, bytes, SupportsInt, SupportsIndex, _SupportsTrunc] = ...,
    ) -> _T: ...
    @overload
...
class complex:
    ...
    @overload
    def __new__(
        cls: Type[_T], real: Union[str, SupportsComplex, SupportsIndex]
    ) -> _T: ...
    @property
    def real(self) -> float: ...
    @property
...
class filter(Iterator[_T], Generic[_T]):
    @overload
    def __init__(
        self, __function: None, __iterable: Iterable[Optional[_T]]
    ) -> None: ...
    @overload
    def __init__(
