...
_CanvasItemId = (
    int  # handles for items created on a canvas - can be passed to Canvas.delete()
)
...
class Misc:
    ...
    def winfo_atomname(
        self, id: int, displayof: Union[Literal[0], Misc, None] = ...
    ): ...
    ...
    def winfo_containing(
        self, rootX: int, rootY: int, displayof: Union[Literal[0], Misc, None] = ...
    ) -> Optional[Misc]: ...
    ...
    def winfo_interps(
        self, displayof: Union[Literal[0], Misc, None] = ...
    ) -> Tuple[str, ...]: ...
    ...
    def register(
        self,
        func: Callable[..., Any],
        subst: Optional[Callable[..., Sequence[Any]]] = ...,
        needcleanup: int = ...,
    ) -> str: ...
...
class Wm:
    ...
    def wm_overrideredirect(
        self, boolean: None = ...
    ) -> Optional[bool]: ...  # returns True or None
    @overload
...
class Canvas(Widget, XView, YView):
    ...
    if sys.version_info >= (3, 8):
        def moveto(
            self,
            tagOrId: Union[str, _CanvasItemId],
            x: Union[Literal[""], float] = ...,
            y: Union[Literal[""], float] = ...,
        ) -> None: ...
...
class Menu(Widget):
    ...
    def add_separator(
        self, cnf: Optional[Dict[str, Any]] = ..., *, background: _Color = ...
    ) -> None: ...
    def insert_cascade(
        self,
        index: _MenuIndex,
...
class Text(Widget, XView, YView):
    ...
    def insert(
        self, index: _TextIndex, chars: str, *args: Union[str, _TkinterSequence[str]]
    ) -> None: ...
    @overload
    def mark_gravity(
    ...
    def replace(
        ...
        index2: _TextIndex,
        chars: str,
        *args: Union[str, _TkinterSequence[str]],
    ) -> None: ...
...
class PhotoImage(Image):
    ...
    def put(
        self,
        data: Union[str, _TkinterSequence[str], _TkinterSequence2D[_Color]],
    ...
    def write(
        ...
        filename: AnyPath,
        format: Optional[str] = ...,
        from_coords: Optional[Tuple[int, int]] = ...,
    ) -> None: ...
    if sys.version_info >= (3, 8):
