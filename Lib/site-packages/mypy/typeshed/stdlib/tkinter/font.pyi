...
class Font:
    ...
    @overload
    def actual(
        self, option: Literal["family"], displayof: Optional[tkinter.Misc] = ...
    ) -> str: ...
    @overload
    def actual(
    ...
    @overload
    def actual(
        self, option: Literal["weight"], displayof: Optional[tkinter.Misc] = ...
    ) -> Literal["normal", "bold"]: ...
    @overload
    def actual(
    ...
    @overload
    def metrics(
        self, __option: Literal["fixed"], *, displayof: Optional[tkinter.Misc] = ...
    ) -> bool: ...
    @overload
