...
class tixCommand:
    ...
    def tix_resetoptions(
        self, newScheme: str, newFontSet: str, newScmPrio: Optional[str] = ...
    ) -> None: ...
...
class TixWidget(tkinter.Widget):
    ...
    def image_create(
        ...
        imgtype: str,
        cnf: Dict[str, Any] = ...,
        master: Optional[tkinter.Widget] = ...,
        **kw: Any
    ) -> None: ...
...
class OptionMenu(TixWidget):
    def __init__(
        self, master: Optional[tkinter.Widget], cnf: Dict[str, Any] = ..., **kw: Any
    ) -> None: ...
