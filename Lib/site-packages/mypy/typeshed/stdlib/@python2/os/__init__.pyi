...
def spawnl(
    mode: int, path: AnyPath, arg0: Union[bytes, Text], *args: Union[bytes, Text]
) -> int: ...
def spawnle(
...
def spawnve(
    mode: int, path: AnyPath, args: List[Union[bytes, Text]], env: Mapping[str, str]
) -> int: ...
...
if sys.platform == "win32":
    ...
    # Unix only
    def spawnlp(
        mode: int, file: AnyPath, arg0: Union[bytes, Text], *args: Union[bytes, Text]
    ) -> int: ...
    def spawnlpe(
    ...
    def spawnvpe(
        mode: int, file: AnyPath, args: List[Union[bytes, Text]], env: Mapping[str, str]
    ) -> int: ...
