...
class int:
    ...
    def __new__(
        cls: Type[_T],
        x: Union[Text, bytes, SupportsInt, _SupportsIndex, _SupportsTrunc] = ...,
    ) -> _T: ...
    @overload
...
class unicode(basestring, Sequence[unicode]):
    ...
    def endswith(
        self,
        __suffix: Union[unicode, Tuple[unicode, ...]],
    ...
    def startswith(
        self,
        __prefix: Union[unicode, Tuple[unicode, ...]],
        __start: Optional[int] = ...,
        __end: Optional[int] = ...,
    ) -> bool: ...
...
class str(Sequence[str], basestring):
    ...
    def endswith(
        self,
        __suffix: Union[Text, Tuple[Text, ...]],
        __start: Optional[int] = ...,
        __end: Optional[int] = ...,
    ) -> bool: ...
    ...
    def startswith(
        self,
        __prefix: Union[Text, Tuple[Text, ...]],
        __start: Optional[int] = ...,
        __end: Optional[int] = ...,
    ) -> bool: ...
    @overload
