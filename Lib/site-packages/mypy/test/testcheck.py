...
class TypeCheckSuite(DataSuite):
    ...
    def run_case_once(
        ...
        if incremental_step == 0:
            ...
            msg = (
                "Unexpected type checker output in incremental, run {}".format(
                    incremental_step
                )
                + " ({}, line {})"
            )
        ...
        if res:
            ...
            actual = [
                ...
                for t in actual
                if not any(
                    t.startswith(mod) for mod in core_modules + ["mypy_extensions"]
                )
            ]
        ...
        if m:
            ...
            for module_name in module_names.split(" "):
                ...
                assert isinstance(path, str), (
                    "Can't find ad hoc case file: %s" % module_name
                )
