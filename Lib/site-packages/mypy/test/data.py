...
UpdateFile = NamedTuple(
    "UpdateFile", [("module", str), ("source_path", str), ("target_path", str)]
)

# File delete operation: delete module file.
DeleteFile = NamedTuple("DeleteFile", [("module", str), ("path", str)])
...
class DataDrivenTestCase(pytest.Item):
    ...
    def teardown(self) -> None:
        assert (
            self.old_cwd is not None and self.tmpdir is not None
        ...
        for possible_err_comment in input[i].split(" # ")[1:]:
            ...
            if m:
                ...
                if col is None:
                    ...
                    output.append(
                        "{}:{}:{}: {}: {}".format(fnam, i + 1, col, severity, message)
                    )
...
def split_test_cases(
    parent: "DataSuiteCollector", suite: "DataSuite", file: str
