...
NAME_DEFINED = ErrorCode(
    "name-defined", "Check that name is defined", "General"
)  # type: Final
CALL_ARG = ErrorCode(
    "call-arg", "Check number, names and kinds of arguments in calls", "General"
)  # type: Final
ARG_TYPE = ErrorCode(
    "arg-type", "Check argument types in calls", "General"
)  # type: Final
...
INDEX = ErrorCode("index", "Check indexing operations", "General")  # type: Final
OPERATOR = ErrorCode(
...
SYNTAX = ErrorCode("syntax", "Report syntax errors", "General")  # type: Final

# This is a catch-all for remaining uncategorized errors.
MISC = ErrorCode("misc", "Miscellaneous other checks", "General")  # type: Final
