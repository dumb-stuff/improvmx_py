...
FunctionSig = NamedTuple(
    "FunctionSig", [("name", str), ("args", List[ArgSig]), ("ret_type", str)]
)
    ...
    def add_token(self, token: tokenize.TokenInfo) -> None:
        ...
        if (
            ...
            try:
                ...
                self.args.append(
                    ArgSig(
                        name=self.arg_name, type=None, default=bool(self.arg_default)
                    )
                )
            self.arg_name = ""
            self.arg_type = None
        ...
        # ENDMAKER is necessary for python 3.4 and 3.5.
            ...
            -1
        ] in (STATE_INIT, STATE_RETURN_VALUE):
