...
class IRBuilder:
    def __init__(
        ...
        self.symtables = [
            OrderedDict()
        ]  # type: List[OrderedDict[SymbolNode, SymbolTarget]]
    ...
    def init_final_static(
        ...
        *,
        type_override: Optional[RType] = None
    ) -> None:
    ...
    def load_final_static(
        self, fullname: str, typ: RType, line: int, error_name: Optional[str] = None
    ) -> Value:
    ...
    def load_final_literal_value(
        self, val: Union[int, str, bytes, float, bool], line: int
    ) -> Value:
    ...
    def assign(
        self, target: Union[Register, AssignmentTarget], rvalue_reg: Value, line: int
    ) -> None:
    ...
    def spill(self, value: Value) -> AssignmentTarget:
        ...
        target = self.add_var_to_env_class(
            Var(name), value.type, self.fn_info.generator_class
        )
    ...
    def process_conditional(
        self, e: Expression, true: BasicBlock, false: BasicBlock
    ) -> None:
    ...
    def flatten_classes(
        self, arg: Union[RefExpr, TupleExpr]
    ) -> Optional[List[ClassIR]]:
    ...
    def add_argument(
        self, var: Union[str, Var], typ: RType, kind: int = ARG_POS
    ) -> Register:
