...
def transform_for_stmt(builder: IRBuilder, s: ForStmt) -> None:
    ...
    for_loop_helper(
        builder, s.index, s.expr, body, else_block if s.else_body else None, s.line
    )
...
def transform_with_stmt(builder: IRBuilder, o: WithStmt) -> None:
    ...
    def generate(i: int) -> None:
        if i >= len(o.expr):
            ...
            transform_with(
                builder, o.expr[i], o.target[i], lambda: generate(i + 1), o.line
            )
