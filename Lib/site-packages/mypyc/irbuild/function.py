...
def handle_yield_from_and_await(
    builder: IRBuilder, o: Union[YieldFromExpr, AwaitExpr]
) -> Value:
...
def gen_glue_method(
    ...
    arg_names = [
        arg.name if arg.kind in (ARG_NAMED, ARG_NAMED_OPT) else None for arg in rt_args
    ]
