...
class str:
    ...
    def replace(self, old: str, new: str, maxcount: Optional[int] = None) -> str:
        pass
...
class bytes:
    ...
    def __add__(self, x: object) -> bytes:
        pass
...
class dict(Mapping[K, V]):
    ...
    def setdefault(self, k: K, v: Optional[V] = None) -> Optional[V]:
        pass
...
def range(x: int, y: int = ..., z: int = ...) -> Iterator[int]:
    pass
