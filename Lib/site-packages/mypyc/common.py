...
DUNDER_PREFIX = (
    "CPyDunder_"
)  # type: Final # Wrappers for exposing dunder methods to the API
...
TOP_LEVEL_NAME = (
    "__top_level__"
)  # type: Final # Special function representing module top level
...
IS_MIXED_32_64_BIT_BUILD = sys.platform in ["darwin"] and sys.version_info < (
    3,
    6,
)  # type: Final
...
MAX_LITERAL_SHORT_INT = (
    sys.maxsize >> 1 if not IS_MIXED_32_64_BIT_BUILD else 2 ** 30 - 1
)  # type: Final
